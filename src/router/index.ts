...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: () => import('@/views/ArcticleManage/ArcticleList.vue'),
        name: 'ArcticleList',
        meta: {
          title: t('router.arctileList'),
          noCache: true
        }
      },
      {
        path: 'tagManage',
        component: () => import('@/views/ArcticleManage/TagManage.vue'),
        name: 'TagManage',
        meta: {
          title: t('router.tagManage'),
          noCache: true
        }
      },
      {
        path: 'categoryManage',
        component: () => import('@/views/ArcticleManage/CategoryManage.vue'),
        name: 'CategoryManage',
        meta: {
          title: t('router.categoryManage'),
          noCache: true
        }
      }
    ]
